...
export default function Hero() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setBlurImages(true);
    }, 15000); // Apply blur after 15 seconds
  ...
  return (
    <>
      <section className="mt-10">
        <h1 className="text-5xl font-abel md:w-[50rem] mx-auto text-center">
          Art is not a mirror held up to reality, but a hammer with which to
          shape it
        </h1>
        <p className="mt-12 md:w-[40rem] mx-auto text-center">
        ...
        <div className="hidden md:flex items-center gap-6 justify-center mt-16">
      ...
      <section className="my-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center md:flex-nowrap relative md:static">
          <div className="flex-grow md:w-auto md:max-w-[50%]">
            <h3 className="text-start text-3xl mb-4 text-black font-bold">
